...
export default function AISubscription_razorpay() {
    ...
    const rzrpayID = process.env.RZRPAY_ACCESS_KEY_ID;
    const rzrpayKey = process.env.RZRPAY_SECRET_KEY;
    ...
    const handleTestPayment = () => {
        ...
        const options = {
            ...
            handler: function (res) {
                ...
                console.log("Payment ID Recieved:", response.razorpay_payment_id);
    ...
    return (
        <>
            <div style={{ padding: '20px', textAlign: 'center' }}>
                ...
                <p>Test premium token assignment with a simulated ₹199 sandbox layer.</p>
                <button
